...
export const DEMO_RELIEFS: DemoRelief[] = [
  {
    ...
    material: "alabaster",
    numbers: [6, 8, 5, 1, 9],
    note: "плотная масса, резкий выход",
  },
  {
    id: "d02",
    title: "Демо 02",
  ...
  },
  {
    ...
    material: "alabaster",
    numbers: [4, 6, 8, 3, 7],
    note: "разлом в мягком материале",
  },
  {
    id: "d10",
    title: "Демо 10",
  ...
  },
  {
    ...
    material: "obsidian",
    numbers: [3, 8, 9, 1, 6],
    note: "низкая плотность, много воздуха",
  },
];
